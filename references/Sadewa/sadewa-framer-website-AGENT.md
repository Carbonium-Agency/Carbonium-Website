# You are building UI in the sadewa.framer.website design system.
...
- title         Sadewa - AI Automation Agency Framer Template
- page intent   landing
- material      flat
- design grade  B
...
- secondary   #98fe00
- accent      #ff9500
- neutrals    #000000 · #131313 · #f3f3f3 · #ffffff · #797979 · #d3d3d3

## Typography

- families   Satoshi · Roboto Mono · Times New Roman · Geist
- weights    400 · 500 · 700 · 600
- base size  16px

## Spacing

- scale      1px · 30px · 40px · 48px · 56px · 64px · 70px · 80px · 100px · 110px · 130px · 140px

## Radii

- scale      1px · 4px · 10px · 14px · 50px · 64px

## Motion

- durations  200ms · 400ms · 1000ms · 1900ms
...
```bash
npx designlang sadewa.framer.website
```
...
Generated by designlang. Re-extract by running `npx designlang sadewa.framer.website`.
