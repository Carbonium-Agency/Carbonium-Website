...
//
//   import { transitions, variants } from './sadewa.framer.website-motion.framer';
...
export const transitions = {
  base:  { duration: 1, ease: easings.custom1 },
  fast:  { duration: 0.500, ease: easings.custom1 },
  slow:  { duration: 1.800, ease: easings.custom1 },
  spring: springs.soft,
};
...
export const variants = {
  ...
  stagger: {
    hidden: {},
    show:   { transition: { staggerChildren: 0.250 } },
  },
};
