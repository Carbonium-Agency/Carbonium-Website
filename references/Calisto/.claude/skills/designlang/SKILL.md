...
description: Use when styling UI for calisto.framer.website — references the extracted design system tokens instead of inventing colors, spacing, or typography.
---
