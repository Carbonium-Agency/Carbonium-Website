# You are building UI in the agent.framer.wiki design system.
...
- secondary   #0000ee
- accent      #82dbf7
- neutrals    #000000 · #ffffff · #9ba5b5 · #4e5b6d · #273241 · #e9ebef

## Typography

- families   Geist · Times New Roman · Inter · Plus Jakarta Sans
- weights    400 · 500 · 600 · 700
- base size  16px

## Spacing

- scale      1px · 20px · 24px · 30px · 36px · 40px · 48px · 64px · 80px · 88px · 96px

## Radii

- scale      3px · 6px · 10px · 16px · 20px · 24px
...
```bash
npx designlang agent.framer.wiki
```
...
Generated by designlang. Re-extract by running `npx designlang agent.framer.wiki`.
