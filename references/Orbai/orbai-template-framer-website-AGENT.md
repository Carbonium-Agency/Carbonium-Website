# You are building UI in the orbai-template.framer.website design system.
...
- families   Inter · Satoshi · Times New Roman
- weights    400 · 500 · 700 · 600
- base size  16px

## Spacing

- scale      4px · 20px · 24px · 30px · 40px · 44px · 60px · 80px · 100px · 160px · 200px

## Radii

- scale      5px · 8px · 11px · 14px · 20px · 23px
...
```bash
npx designlang orbai-template.framer.website
```
...
Generated by designlang. Re-extract by running `npx designlang orbai-template.framer.website`.
